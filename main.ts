...
async function quizApp() {
  ...
  if (result.result === "VIEW RESULT:") {
    ...
    if (mcqsInput.ques1 === "JavaScript") {
      ...
      console.log(
        chalk.red.bold.italic(`\t        YOU CHOOSE: ${mcqsInput.ques1}`) +
    ...
    if (mcqsInput.ques2 === "push()") {
      ...
      console.log(
        chalk.red.bold.italic(`\t        YOU CHOOSE: ${mcqsInput.ques2}`) +
    ...
    if (mcqsInput.ques3 === "It's a superset of JavaScript") {
      ...
      console.log(
        chalk.red.bold.italic(`\t   YOU CHOOSE: ${mcqsInput.ques3}`) +
          chalk.green.bold.italic(
    ...
    if (mcqsInput.ques4 === "Any type") {
      ...
      console.log(
        chalk.red.bold.italic(`\t        YOU CHOOSE: ${mcqsInput.ques4}`) +
    ...
    if (mcqsInput.ques5 === "function") {
      ...
      console.log(
        chalk.red.bold.italic(`\t        YOU CHOOSE: ${mcqsInput.ques5}`) +
    ...
    if (mcqsInput.ques6 === "===") {
      ...
      console.log(
        chalk.red.bold.italic(`\t        YOU CHOOSE: ${mcqsInput.ques6}`) +
    ...
    if (mcqsInput.ques7 === "//") {
      ...
      console.log(
        chalk.red.bold.italic(`\t        YOU CHOOSE: ${mcqsInput.ques7}`) +
          chalk.green.bold.italic(`\n\t    BUT CORRECT ANSWER IS: "//"`)
      );
      console.log(
        chalk.yellow.bold(`\t===========================================`)
    ...
    if (mcqsInput.ques8 === "Interfaces") {
      ...
      console.log(
        chalk.red.bold.italic(`\t        YOU CHOOSE: ${mcqsInput.ques8}`) +
    ...
    if (mcqsInput.ques9 === "TypeScript") {
      ...
      console.log(
        chalk.red.bold.italic(`\t        YOU CHOOSE: ${mcqsInput.ques9}`) +
    ...
    if (mcqsInput.ques10 === "All of the above") {
      ...
      console.log(
        chalk.red.bold.italic(`\t        YOU CHOOSE: ${mcqsInput.ques10}`) +
          chalk.green.bold.italic(
